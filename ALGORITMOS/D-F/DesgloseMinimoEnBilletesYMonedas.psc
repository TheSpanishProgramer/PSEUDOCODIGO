Proceso DesgloseMinimoEnBilletesYMonedas
	Escribir Sin Saltar "Ingrese el valor de cantidad de euros:";
	Leer cantidad_de_euros;
	...
	billetes_de_5 <- (monedas_de_1-monedas_de_1 MOD 5)/5;
